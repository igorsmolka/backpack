...
public class VariantService {
    ...
    // глобально же - мы скорее всего будем нарезать без рутовой части, просто до выхода за капасити - и вот такое сочетание. и соотносить между собой такие порции. посмотрим, что из этого выйдет.
